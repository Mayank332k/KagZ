...
export const AiCodeBlock: React.FC<AiCodeBlockProps> = ({
  ...
  const displayedCode = useMemo(() => {
    return displayedLines.map(line => line.map(tok => tok.text).join("")).join("\n");
  }, [displayedLines]);

  // Variant container styles
  const containerVariants = {
    default:
      "bg-[#EEF0F2] dark:bg-[#181818] border-zinc-200 dark:border-zinc-800/90 text-zinc-900 dark:text-zinc-100 shadow-sm",
    glass:
    ...
    dark:
      "bg-[#EEF0F2] dark:bg-[#181818] border-[#E5E7EB] dark:border-zinc-800/90 text-[#1a1a1a] dark:text-zinc-100 shadow-sm",
  };

  const headerVariants = {
    default: "border-b border-[#E5E7EB] dark:border-zinc-800/80 bg-zinc-100/60 dark:bg-[#181818]",
    ...
    dark: "border-b border-[#E5E7EB] dark:border-zinc-800/80 bg-[#E5E7EB] dark:bg-[#1c1c1c]",
  };
  ...
  return (
    ...
    >
      ...
      {/* Code Body Container using SyntaxHighlighter */}
      <div
        className={cn(
          "relative overflow-x-auto transition-all duration-300 text-[13px] leading-relaxed",
      ...
      >
        <SyntaxHighlighter
          ...
          style={{
            ...(isDark ? vscDarkPlus : prism),
            'pre[class*="language-"]': {
              ...(isDark ? vscDarkPlus['pre[class*="language-"]'] : prism['pre[class*="language-"]']),
            ...
            'code[class*="language-"]': {
              ...(isDark ? vscDarkPlus['code[class*="language-"]'] : prism['code[class*="language-"]']),
              background: 'transparent',
              border: 'none',
              boxShadow: 'none',
              textShadow: 'none',
